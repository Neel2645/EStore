...
const EditProductType = ({errorMessage,productType}) => {
  return (
    <div>
      ...
      <form
        ...
        action={async (formData) => updateProductType(formData,productType.id)}
      >
        {
          errorMessage && 
          (
        ...
        <div className="grid gap-2">
          ...
          <Input placeholder="Enter Product Type" name="name" defaultValue={productType.name}/>
        </div>
